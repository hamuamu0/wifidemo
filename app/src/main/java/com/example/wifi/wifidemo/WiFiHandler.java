...
public class WiFiHandler {
    ...
    public static WiFiHandler instance() {
        Log.d("CSF_TAG","WiFiHandler：instance");
        if (null == _instance) {
    ...
    public boolean openWifi() {
        if (null == wifiManager) {
            Log.e("CSF_TAG","WifiManager is null");
            return false;
        }
    ...
    public List<AccessPoint> getScanAp() {
        if (null == wifiManager) {
            Log.d("CSF_TAG","WifiManager is null");
            return null;
        }
        List<ScanResult> results = wifiManager.getScanResults();
        if (results == null || results.size() <= 0) {
            Log.d("CSF_TAG","ScanResults are null");
            wifiManager.startScan();
            return null;
        }
        ...
        for (ScanResult result : results) {
            ...
            Log.d("CSF_TAG","SSID:" + result.SSID);
            Log.d("CSF_TAG","BSSID:" + result.BSSID);
            Log.d("CSF_TAG","capabilities:" + result.capabilities);
            Log.d("CSF_TAG","frequency:" + result.frequency);
            Log.d("CSF_TAG","level:" + result.level);
            try {
    ...
    public WifiConfiguration createConfiguration(AccessPoint ap) {
        ...
        Log.d("CSF_TAG","create a config for " + SSID);
